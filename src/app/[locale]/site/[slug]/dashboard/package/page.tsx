...
export default async function CustomerPackagePage({ params }: CustomerPackagePageProps) {
              ...
              >
                ...
                <div className="mt-6 grid gap-2 sm:grid-cols-2">
                  ...
                  <Button
                    ...
                    className={cn(
                      "h-11",
                      isCurrent ? "bg-slate-200 text-slate-500" : "bg-slate-950 text-white hover:bg-teal-800"
                    )}
                    title={isCurrent ? "This is your current plan." : "Payment checkout will be connected here."}
                  >
                    {isCurrent ? "Current" : isOwnershipPlan ? "Ownership checkout soon" : "Checkout coming soon"}
                  </Button>
                </div>
              </article>
            );
