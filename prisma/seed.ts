...
import {
  ...
  supportRequests,
} from "../src/data/platform-admin";
import { defaultThemeCustomizationPolicy } from "../src/config/theme-customization";
import {
  localizedPlatformCopy,
  platformLocales,
} from "../src/i18n/platform-copy";
import { platformBlogArticles } from "../src/data/platform-blog";

const prisma = new PrismaClient();

function localizedSeed(
  en: string,
  translations: Partial<Record<(typeof platformLocales)[number], string>> = {},
) {
  return localizedPlatformCopy(en, translations);
}

function localizedSeedList(values: readonly string[]) {
  return values.map((value) => localizedSeed(value));
}

function localizedThemeSeoTitleSeed(themeName: string) {
  const suffix = localizedSeed("Photography Website Theme");

  return Object.fromEntries(
    platformLocales.map((locale) => [
      locale,
      `${themeName} ${suffix[locale]} - Photaaz`,
    ]),
  ) as Record<(typeof platformLocales)[number], string>;
}
...
async function seedFeaturesAndPlans() {
  ...
  for (const feature of features) {
    const record = await prisma.feature.upsert({
      ...
      update: {
        name: feature.name,
        nameI18n: localizedSeed(feature.name),
        description: feature.description,
        descriptionI18n: localizedSeed(feature.description),
      },
      create: {
        ...feature,
        nameI18n: localizedSeed(feature.name),
  ...
  for (const [index, plan] of plans.entries()) {
    const planRecord = await prisma.plan.upsert({
      ...
      update: {
        name: plan.name,
        nameI18n: localizedSeed(plan.name),
        description: plan.description,
        descriptionI18n: localizedSeed(plan.description),
...
async function seedDemoTenant() {
  ...
  const photoSeedData = [
    ...
    {
      id: "demo-photo-2",
      albumId: sarahAhmedAlbum.id,
      categoryId: weddingsCategory.id,
      title: "Ceremony arch",
      alt: "Floral ceremony arch in a garden setting",
      photoId: "photo-1465495976277-4387d4b0b4c6",
      cloudinaryId: "demo/ceremony-arch",
      dominantColor: "#7a8b6e",
    },
    {
      id: "demo-photo-3",
      albumId: sarahAhmedAlbum.id,
      ...
      alt: "Couple sharing their first dance at the reception",
      photoId: "photo-1519225421980-715cb0215aed",
      cloudinaryId: "demo/reception-dance",
      dominantColor: "#4a3f35",
    },
    {
      id: "demo-photo-4",
      albumId: sarahAhmedAlbum.id,
      categoryId: weddingsCategory.id,
      title: "Couple in garden",
      alt: "Bride and groom walking through a sunlit garden",
      photoId: "photo-1537907510278-7709f15909a7",
      cloudinaryId: "demo/couple-in-garden",
      dominantColor: "#6b8e5a",
    },
    {
      id: "demo-photo-5",
      albumId: featuredWorkAlbum.id,
      ...
      photoId: "photo-1522673607200-164d1b6ce486",
      cloudinaryId: "demo/bridal-preparation",
    ...
    },
    {
      ...
      categoryId: weddingsCategory.id,
      title: "First dance",
      alt: "Couple dancing under warm string lights",
      photoId: "photo-1511285560929-80b456fea0bc",
      cloudinaryId: "demo/first-dance",
      dominantColor: "#3d3027",
    },
    {
      id: "demo-photo-7",
      albumId: sarahAhmedAlbum.id,
      categoryId: weddingsCategory.id,
      title: "Ring exchange",
      alt: "Close-up of the ring exchange during the ceremony",
      photoId: "photo-1591604466107-ec97de577aff",
      cloudinaryId: "demo/ring-exchange",
      dominantColor: "#b8a089",
    },
    {
      id: "demo-photo-8",
      albumId: sarahAhmedAlbum.id,
      categoryId: weddingsCategory.id,
      title: "Wedding party",
      alt: "Wedding party group portrait in a park",
      photoId: "photo-1583939003579-730e3918a45a",
      cloudinaryId: "demo/wedding-party",
      dominantColor: "#8a7b6b",
    },
    {
      id: "demo-photo-9",
      albumId: sarahAhmedAlbum.id,
      ...
      alt: "Elegant bridal portrait with natural light",
      photoId: "photo-1520854221256-17451cc331bf",
      cloudinaryId: "demo/bride-portrait",
      dominantColor: "#c8b8a0",
    },
    {
      id: "demo-photo-10",
      albumId: sarahAhmedAlbum.id,
      categoryId: weddingsCategory.id,
      title: "Sunset couple walk",
      alt: "Couple walking hand in hand during sunset",
      photoId: "photo-1606800052052-a08af7148866",
      cloudinaryId: "demo/sunset-couple-walk",
      dominantColor: "#d4956b",
    },
    {
      id: "demo-photo-11",
      albumId: sarahAhmedAlbum.id,
      categoryId: weddingsCategory.id,
      title: "Bouquet toss",
      alt: "Bride tossing the bouquet to wedding guests",
      photoId: "photo-1519741497674-611481863552",
      cloudinaryId: "demo/bouquet-toss",
      dominantColor: "#8f6d4c",
    },
    {
      id: "demo-photo-12",
      ...
      photoId: "photo-1544078751-58fee2d8a03b",
      cloudinaryId: "demo/table-details",
      dominantColor: "#c9b896",
    },
    ...
    // Portrait photos (13-22)
    {
      ...
      alt: "Dramatic studio portrait with controlled lighting",
      photoId: "photo-1531746020798-e6953c6e8e04",
      cloudinaryId: "demo/studio-portrait",
      dominantColor: "#d4b896",
    },
    {
      id: "demo-photo-14",
      albumId: urbanPortraitsAlbum.id,
      categoryId: portraitsCategory.id,
      title: "Professional headshot",
      alt: "Clean professional headshot on neutral background",
      photoId: "photo-1507003211169-0a1dd7228f2d",
      cloudinaryId: "demo/professional-headshot",
      dominantColor: "#6b7b8b",
    },
    {
      id: "demo-photo-15",
      albumId: urbanPortraitsAlbum.id,
      ...
      alt: "Portrait shot in soft natural window light",
      photoId: "photo-1494790108377-be9c29b29330",
      cloudinaryId: "demo/natural-light-portrait",
      dominantColor: "#b8956e",
    },
    {
      id: "demo-photo-16",
      albumId: urbanPortraitsAlbum.id,
      ...
      alt: "Fashion-forward portrait with urban backdrop",
      photoId: "photo-1534528741775-53994a69daeb",
      cloudinaryId: "demo/fashion-portrait",
      dominantColor: "#8b9ba5",
    },
    {
      id: "demo-photo-17",
      albumId: urbanPortraitsAlbum.id,
      ...
      alt: "Candid portrait on a busy city street",
      photoId: "photo-1544005313-94ddf0286df2",
      cloudinaryId: "demo/street-portrait",
      dominantColor: "#7a6b5a",
    },
    {
      id: "demo-photo-18",
      albumId: urbanPortraitsAlbum.id,
      ...
      alt: "Subject photographed in their natural environment",
      photoId: "photo-1517841905240-472988babdf9",
      cloudinaryId: "demo/environmental-portrait",
      dominantColor: "#a89880",
    },
    {
      id: "demo-photo-19",
      albumId: urbanPortraitsAlbum.id,
      ...
      alt: "Portrait with dramatic side lighting and deep shadows",
      photoId: "photo-1521119989659-a83eee488004",
      cloudinaryId: "demo/dramatic-lighting",
    ...
    },
    {
      ...
      categoryId: portraitsCategory.id,
      title: "Male headshot",
      alt: "Professional male headshot with clean background",
      photoId: "photo-1506794778202-cad84cf45f1d",
      cloudinaryId: "demo/male-headshot",
      dominantColor: "#8a7a6a",
    },
    {
      id: "demo-photo-21",
      albumId: urbanPortraitsAlbum.id,
      ...
      alt: "Intimate couple portrait in urban setting",
      photoId: "photo-1524504388940-b1c1722653e1",
      cloudinaryId: "demo/couple-portrait",
    ...
    },
    {
      ...
      alt: "Relaxed lifestyle portrait in natural setting",
      photoId: "photo-1488426862026-3ee34a7d66df",
      cloudinaryId: "demo/lifestyle-portrait",
      dominantColor: "#c4a478",
    },
    ...
    // Nature photos (23-32)
    {
      ...
      alt: "Sun rising over snow-capped alpine peaks",
      photoId: "photo-1506905925346-21bda4d32df4",
      cloudinaryId: "demo/alpine-sunrise",
      dominantColor: "#6a8ca5",
    },
    {
      id: "demo-photo-24",
      albumId: mountainSunriseAlbum.id,
      categoryId: natureCategory.id,
      title: "Mountain lake",
      alt: "Still mountain lake reflecting surrounding peaks",
      photoId: "photo-1470770841072-f978cf4d019e",
      cloudinaryId: "demo/mountain-lake",
      dominantColor: "#4a6a3e",
    },
    {
      id: "demo-photo-25",
      albumId: mountainSunriseAlbum.id,
      ...
      alt: "Crystal clear water on a tropical shoreline",
      photoId: "photo-1500530855697-b586d89ba3ee",
      cloudinaryId: "demo/tropical-beach",
      dominantColor: "#5ea0b8",
    },
    {
      id: "demo-photo-26",
      albumId: mountainSunriseAlbum.id,
      ...
      cloudinaryId: "demo/forest-path",
      dominantColor: "#3a5a2e",
    },
    {
      id: "demo-photo-27",
      albumId: mountainSunriseAlbum.id,
      categoryId: natureCategory.id,
      title: "Valley view",
      alt: "Expansive valley view from a mountain ridge",
      photoId: "photo-1472214103451-9374bd1c798e",
      cloudinaryId: "demo/valley-view",
      dominantColor: "#7a9a5e",
    },
    {
      id: "demo-photo-28",
      albumId: mountainSunriseAlbum.id,
      categoryId: natureCategory.id,
      title: "Waterfall",
      alt: "Cascading waterfall surrounded by mossy rocks",
      photoId: "photo-1433086966358-54859d0ed716",
      cloudinaryId: "demo/waterfall",
    ...
    },
    {
      ...
      categoryId: natureCategory.id,
      title: "Desert dunes",
      alt: "Wind-sculpted sand dunes at golden hour",
      photoId: "photo-1518173946687-a252ee9a267c",
      cloudinaryId: "demo/desert-dunes",
      dominantColor: "#c8a878",
    },
    {
      id: "demo-photo-30",
      albumId: mountainSunriseAlbum.id,
      ...
      photoId: "photo-1505765050516-f72dcac9c60e",
      cloudinaryId: "demo/coastal-cliffs",
    ...
    },
    {
      ...
      categoryId: natureCategory.id,
      title: "Snow peaks",
      alt: "Pristine snow-covered mountain peaks at dawn",
      photoId: "photo-1486870591958-9b9d0d1dda99",
      cloudinaryId: "demo/snow-peaks",
      dominantColor: "#8aaabe",
    },
    {
      id: "demo-photo-32",
      albumId: mountainSunriseAlbum.id,
      categoryId: natureCategory.id,
      title: "Misty forest",
      alt: "Ethereal mist drifting through an ancient forest",
      photoId: "photo-1501854140801-50d01698950b",
      cloudinaryId: "demo/misty-forest",
    ...
    // Event photos (33-40)
    {
      ...
      alt: "Speaker on stage at a corporate conference",
      photoId: "photo-1540575467063-178a50c2df87",
      cloudinaryId: "demo/conference-stage",
      dominantColor: "#2a3a4a",
    },
    {
      id: "demo-photo-34",
      albumId: grandGalaAlbum.id,
      categoryId: eventsCategory.id,
      title: "Gala dinner",
      alt: "Elegant gala dinner with ambient lighting",
      photoId: "photo-1511795409834-ef04bbd61622",
      cloudinaryId: "demo/gala-dinner",
    ...
    },
    {
      ...
      alt: "Joyful birthday celebration with colorful decorations",
      photoId: "photo-1530103862676-de8c9debad1d",
      cloudinaryId: "demo/birthday-celebration",
      dominantColor: "#c8a060",
    },
    {
      id: "demo-photo-36",
      albumId: grandGalaAlbum.id,
      ...
      alt: "Graduates celebrating at a commencement ceremony",
      photoId: "photo-1523050854058-8df90110c9f1",
      cloudinaryId: "demo/graduation-ceremony",
      dominantColor: "#3a4a5a",
    },
    {
      id: "demo-photo-37",
      albumId: grandGalaAlbum.id,
      ...
      alt: "Musician performing on stage under colored lights",
      photoId: "photo-1492684223f8-5a77a9e38a44",
      cloudinaryId: "demo/live-performance",
      dominantColor: "#5a3a6a",
    },
    {
      id: "demo-photo-38",
      albumId: grandGalaAlbum.id,
      categoryId: eventsCategory.id,
      title: "Team meeting",
      alt: "Corporate team collaborating in a modern workspace",
      photoId: "photo-1505373877841-8d25f7d46678",
      cloudinaryId: "demo/team-meeting",
    ...
    },
    {
      ...
      alt: "Award presentation at a formal ceremony",
      photoId: "photo-1504384764586-bb4cdc1707b0",
      cloudinaryId: "demo/award-ceremony",
      dominantColor: "#3a2a1a",
    },
    {
      id: "demo-photo-40",
      albumId: grandGalaAlbum.id,
      ...
      photoId: "photo-1556761175-5973dc0f32e7",
      cloudinaryId: "demo/networking-event",
    ...
    // Street photos (41-45) — no album
    {
      id: "demo-photo-41",
      albumId: null,
      categoryId: streetCategory.id,
      title: "Night market",
      alt: "Vibrant night market with neon signs and crowds",
      photoId: "photo-1519608487953-e999c86e7455",
      cloudinaryId: "demo/night-market",
      dominantColor: "#2a2a3a",
    },
    {
      id: "demo-photo-42",
      albumId: null,
      ...
      alt: "City street reflections on rain-soaked pavement",
      photoId: "photo-1517732306149-e8f829eb588a",
      cloudinaryId: "demo/rain-reflection",
      dominantColor: "#4a5a6a",
    },
    {
      id: "demo-photo-43",
      albumId: null,
      categoryId: streetCategory.id,
      title: "City lights",
      alt: "Blurred city lights creating a bokeh effect at night",
      photoId: "photo-1477959858617-67f85cf4f1df",
      cloudinaryId: "demo/city-lights",
      dominantColor: "#1a2a3a",
    },
    {
      id: "demo-photo-44",
      albumId: null,
      ...
      cloudinaryId: "demo/urban-geometry",
    ...
    },
    {
      ...
      categoryId: streetCategory.id,
      title: "Street vendor",
      alt: "Street food vendor preparing dishes at a stall",
      photoId: "photo-1514565131-fce0801e5785",
      cloudinaryId: "demo/street-vendor",
      dominantColor: "#6a5a4a",
    },
    ...
    // Fashion photos (46-50) — 46 in featured album, 47 no album, 48-50 no album
    {
      ...
      alt: "High-fashion editorial shot with dramatic pose",
      photoId: "photo-1509631179647-0177331693ae",
      cloudinaryId: "demo/editorial-fashion",
      dominantColor: "#d4c4b4",
    },
    {
      id: "demo-photo-47",
      albumId: null,
      categoryId: fashionCategory.id,
      title: "Runway moment",
      alt: "Model walking the runway under spotlights",
      photoId: "photo-1515886657613-9f3515b0c78f",
      cloudinaryId: "demo/runway-moment",
      dominantColor: "#3a3a3a",
    },
    {
      id: "demo-photo-48",
      ...
      categoryId: fashionCategory.id,
      title: "Street style",
      alt: "Street style fashion captured on a city sidewalk",
      photoId: "photo-1469334031218-e382a71b716b",
      cloudinaryId: "demo/street-style",
      dominantColor: "#c4b4a4",
    },
    {
      id: "demo-photo-49",
      albumId: null,
      ...
      alt: "Close-up beauty editorial with soft lighting",
      photoId: "photo-1558618666-fcd25c85f7f7",
      cloudinaryId: "demo/beauty-editorial",
      dominantColor: "#e4d4c4",
    },
    {
      id: "demo-photo-50",
      albumId: null,
      ...
      alt: "Outdoor fashion shoot in natural golden light",
      photoId: "photo-1496747611176-843222e1e57c",
      cloudinaryId: "demo/fashion-outdoor",
      dominantColor: "#b4c4d4",
    },
  ];
...
async function seedPlatformSettings() {
  const appConfigSeed = {
    ...
    socialLinks: {
      instagram: {
        label: "Instagram",
        href: "https://www.instagram.com/bilalshah.photos/",
        enabled: true,
      },
      facebook: {
        label: "Facebook",
        href: "https://www.facebook.com/reallybilalshah",
        enabled: true,
      },
      youtube: {
        label: "YouTube",
        href: "https://www.youtube.com/@bilalshahvlogs",
        enabled: true,
      },
      linkedin: {
        label: "LinkedIn",
        href: "https://www.linkedin.com/in/bilalshahdev/",
        enabled: true,
      },
      snapchat: {
        label: "Snapchat",
        href: "https://www.snapchat.com/add/reallybilalshah",
        enabled: true,
      },
    },
  };
  ...
  const landingSeed = {
    ...
    hero: {
      eyebrow: localizedSeed("Portfolio SaaS for photographers"),
      headline: localizedSeed(
        "Create a professional photography website in minutes.",
      ),
      subheadline: localizedSeed(
        "Pick a design, upload your photos, and publish a polished portfolio that presents your work beautifully.",
      ),
      primaryCta: localizedSeed("Start free"),
      secondaryCta: localizedSeed("View themes"),
    },
    seo: {
      title: localizedSeed(
      ...
      keywords: {
        ...
        tr: [
          "fotograf sitesi",
          "fotograf portfolyosu",
          "fotografci web sitesi",
          "fotograf galerisi",
          "portfolyo sitesi olusturucu",
        ],
        hi: [
          "photography website",
          "photography portfolio",
        ...
        fr: [
          ...
          "site photographe",
          "galerie photo",
          "createur de portfolio",
        ],
      },
    },
    contact: {
      eyebrow: localizedSeed("Questions"),
      title: localizedSeed("Need help choosing the right portfolio setup?"),
      body: localizedSeed(
        "Tell us what kind of photography website you want to launch. We will point you toward the best theme, plan, or domain path.",
      ),
      submitLabel: localizedSeed("Send question"),
    },
    features: benefitFeatures.map((feature, index) => ({
      title: localizedSeed(feature.title),
      body: localizedSeed(feature.body),
    ...
    faqs: [
      ...
      {
        question: localizedSeed("Can I connect my own domain?"),
        answer: localizedSeed(
      ...
      {
        question: localizedSeed("Are translations included?"),
        answer: localizedSeed(
  ...
  for (const [index, theme] of themeShowcases.entries()) {
    await prisma.platformTheme.upsert({
      ...
      update: {
        name: theme.name,
        nameI18n: localizedSeed(theme.name),
        description: theme.description,
        descriptionI18n: localizedSeed(theme.description),
        image: theme.image,
        features: theme.features,
        featuresI18n: localizedSeedList(theme.features),
        iconKey: theme.slug,
        enabled: true,
        ...
        seoTitleI18n: localizedThemeSeoTitleSeed(theme.name),
        seoDescription: theme.description,
        seoDescriptionI18n: localizedSeed(theme.description),
      },
      create: {
        name: theme.name,
        nameI18n: localizedSeed(theme.name),
  ...
  const parentPhotographyTypes = managedPhotographyTypes.filter(
    (type) => !type.parentSlug,
  );
  const childPhotographyTypes = managedPhotographyTypes.filter(
    (type) => type.parentSlug,
  );
  ...
  for (const [index, type] of parentPhotographyTypes.entries()) {
    await prisma.platformPhotographyType.upsert({
      ...
      update: {
        name: type.name,
        nameI18n: localizedSeed(type.name),
        image: type.image,
        parentId: null,
...
async function main() {
  ...
  for (const [index, article] of platformBlogArticles.entries()) {
    await prisma.platformBlogPost.upsert({
      where: { slug: article.slug },
      update: {},
      create: {
        slug: article.slug,
        title: article.title as Prisma.InputJsonValue,
        excerpt: article.excerpt as Prisma.InputJsonValue,
        coverImage: article.coverImage,
        readTime: article.readTime as Prisma.InputJsonValue,
        keywords: article.keywords as Prisma.InputJsonValue,
        sections: article.sections as Prisma.InputJsonValue,
        enabled: true,
        featured: index === 0,
        displayOrder: index + 1,
